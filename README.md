...
4. *view panel:* **resymbolize:** objects. Display querried symbolization, i.e., geographic data, interest data, interest data minus the USA (Tutorial runs through series of real and false projections: [equal worldview (false): countries have same levels of interest], [unequal worldview (false): countries have varying levels of interest], [unequal or most recent worldview (true): contries show example of true/current levels of interest]).
...
8. *regional view panel:* **resymbolize, filter:** objects. Display querried symbolization with added option of regional interest [geographic, global interest, regional interest].
